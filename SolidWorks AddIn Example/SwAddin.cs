...
namespace SolidWorks_AddIn_Example
{
    /// <summary>
    /// Summary description for SolidWorks_AddIn_Example.
    /// </summary>
    [Guid("d35f3f96-88a5-4b5a-b96b-772fa8851728"), ComVisible(true)]
    [SwAddin(
        Description = "SolidWorks_AddIn_Example description",
        Title = "SolidWorks_AddIn_Example",
        LoadAtStartup = true
        )]
